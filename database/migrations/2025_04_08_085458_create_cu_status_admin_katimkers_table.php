...
return new class extends Migration
{
    ...
    {
        Schema::create('cu_status_admin_katimkers', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('cu_status_user_admin_id', 'fk_adminkatimker_useradmin')
                ->references('id')
    ...
    {
        Schema::dropIfExists('cu_status_admin_katimkers');
    }
};
