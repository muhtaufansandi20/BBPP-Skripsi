...
<div class="bg-white rounded-xl shadow-sm overflow-hidden">
    ...
    <div class="bg-gradient-to-r from-orange-400 to-rose-500 p-6">
                ...
                <div class="bg-white rounded-lg border border-gray-100 p-6 w-full md:w-3/5">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4 flex items-center group relative">
                        ...
                        <div class="relative mr-3">
                            <!-- Main Icon -->
                            <svg class="w-6 h-6 text-gray-500 group-hover:text-rose-500 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span class="relative">
                            Informasi Pribadi
                            <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-orange-400 to-rose-500 group-hover:w-full transition-all duration-500 ease-out"></span>
                        </span>
                        <span class="ml-2 px-1.5 py-0.5 text-xs font-medium rounded-full bg-orange-100 text-orange-800 opacity-0 group-hover:opacity-100 translate-x-1 group-hover:translate-x-0 transition-all duration-300">
                            Anda
                        </span>
                    </h2>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            <div class="flex items-center">
                                ...
                                <button onclick="toggleEdit('phone')" class="ml-2 text-gray-400 hover:text-accent focus:outline-none">
                        ...
                        <div>
                            <div class="flex items-center">
                                ...
                                <button onclick="showPasswordModal()" class="ml-2 text-gray-400 hover:text-accent focus:outline-none">
                                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                    </svg>
                                </button>
                    ...
                    <div class="p-2">
                        <div class="flex items-center justify-between mb-4">
                            <h2 class="text-sm font-semibold text-gray-800 flex items-center group relative">
                                <svg class="w-5 h-5 mr-2 text-rose-500 transition-all duration-500 group-hover:text-rose-600 group-hover:rotate-12" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                                ...
                                <span class="relative">
                                    Masa Kerja
                                    <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-orange-400 to-rose-400 group-hover:w-full transition-all duration-300"></span>
                                </span>
                                <span class="ml-1.5 w-2 h-2 rounded-full bg-rose-400 animate-pulse opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                            </h2>
    ...
    <div class="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden transform transition-all duration-300 ease-out">
        ...
        <div class="bg-gray-50 px-6 py-4 flex justify-end space-x-3 border-t border-gray-200">
            ...
            <button type="submit" id="saveButton" form="masaKerjaForm" hidden
                    class="px-5 py-2.5 text-sm font-medium text-white bg-gradient-to-r from-green-500 to-emerald-500 rounded-lg shadow-sm text-sm font-medium text-white hover:from-green-600 hover:to-emerald-600 focus:outline-none focus:ring-2 focus:ring-green-300 shadow-md hover:shadow-green-200 transition-all">
        ...
        @if($masakerja)
            <form action="{{ route('kabagmasakerja.update', $masakerja->id) }}" method="POST" id="masaKerjaForm">
                @csrf
                @method('PUT')
        ...
        @else
            <form action="{{ route('kabagmasakerja.store') }}" method="POST" id="masaKerjaForm">
                @csrf
                <input type="hidden" name="user_id" value="{{ auth()->user()->id }}">
                <input type="hidden" name="jumlah_masa_kerja" id="masaKerjaInput">
            </form>
