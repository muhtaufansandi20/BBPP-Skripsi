...
<div class="bg-white rounded-xl shadow-sm overflow-hidden">
    <!-- Profile Header with Gradient (Biru) -->
    <div class="bg-gradient-to-r from-blue-500 to-cyan-400 p-6">
        <div class="flex items-center space-x-4">
            ...
            <div class="flex-1">
                <div class="flex items-center">
                    ...
                    <button onclick="toggleEdit('name')" class="text-white hover:text-gray-200 focus:outline-none">
                ...
                <form id="name-form" class="hidden mt-2" method="POST" action="{{ route('dashboard.update') }}">
                    @csrf
                    <div class="flex">
                        <input type="text" name="name" value="{{ old('name', $user->name) }}" class="flex-1 px-2 py-1 rounded-l text-gray-800 text-sm">
    ...
    <div class="grid grid-cols-1 gap-6 p-6">
        ...
        <div class="md:col-span-2">
                ...
                <div class="bg-white rounded-lg border border-gray-100 p-6 w-full md:w-3/5">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4 flex items-center group relative">
                        ...
                        <div class="relative mr-3">
                            <svg class="w-6 h-6 text-gray-500 group-hover:text-indigo-600 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span class="relative">
                            Informasi Pribadi
                            <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-indigo-500 to-sky-400 group-hover:w-full transition-all duration-500 ease-out"></span>
                        </span>
                        <span class="ml-2 px-1.5 py-0.5 text-xs font-medium rounded-full bg-indigo-100 text-indigo-800 opacity-0 group-hover:opacity-100 translate-x-1 group-hover:translate-x-0 transition-all duration-300">
                            Anda
                        </span>
                    </h2>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            <p class="text-xs font-medium text-gray-400 uppercase tracking-wider">Tim Kerja</p>
                            <div class="mt-1 flex items-center">
                                <span class="text-gray-700">{{ $timkerja->nama_tim ?? '-' }}</span>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="flex items-center">
                                ...
                                <button onclick="toggleEdit('phone')" class="ml-2 text-gray-400 hover:text-blue-700 focus:outline-none">
                            ...
                            <form id="phone-form" class="hidden mt-2" method="POST" action="{{ route('dashboard.update') }}">
                                @csrf
                                <div class="flex">
                                    <input type="tel" name="no_hp" value="{{ old('no_hp', $user->no_hp) }}" class="flex-1 px-2 py-1 rounded-l text-gray-800 text-sm border border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-500">
                        ...
                        <div>
                            <div class="flex items-center">
                                ...
                                <button onclick="showPasswordModal()" class="ml-2 text-gray-400 hover:text-emerald-600 focus:outline-none">
                                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                    </svg>
                                </button>
                    ...
                    <div class="p-2">
                        <div class="flex items-center justify-between mb-4">
                            <h2 class="text-sm font-semibold text-gray-800 flex items-center group relative">
                                <svg class="w-5 h-5 mr-2 text-blue-500 transition-all duration-500 group-hover:text-blue-600 group-hover:rotate-12" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                                ...
                                <span class="relative">
                                    Masa Kerja
                                    <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-blue-500 to-cyan-400 group-hover:w-full transition-all duration-300"></span>
                                </span>
                                <span class="ml-1.5 w-2 h-2 rounded-full bg-blue-400 animate-pulse opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                            </h2>
                        </div>
                        ...
                        @else
                        <div class="bg-yellow-50 rounded-xl py-11 text-center border-2 border-dashed border-yellow-200">
            ...
            <div class="bg-white rounded-lg border border-gray-100 p-6 mt-6">
                <h2 class="text-lg font-semibold text-gray-800 mb-4 flex items-center group relative">
                    <div class="relative mr-3">
                        <svg class="w-6 h-6 text-transparent stroke-2" fill="none" viewBox="0 0 24 24">
                            <defs>
                            ...
                            <path stroke="url(#calendarGradient)" stroke-linecap="round" stroke-linejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" class="group-hover:stroke-[2.5px] transition-all duration-300"></path>
                        </svg>
                    ...
                    <div class="bg-purple-50 rounded-xl p-6 text-center border-2 border-dashed border-purple-200">
                        ...
                        <div class="mt-4 bg-white rounded-lg p-3 inline-block">
                            <div class="flex items-center text-sm text-purple-700">
                                <svg class="w-6 h-6 sm:w-4 sm:h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button onclick="window.open('https://wa.me/{{ $whatsappNumber }}?text={{ $defaultMessage }}', '_blank')" 
                            ...
                            <span class="text-sm sm:text-base">Hubungi via WhatsApp</span>
                        </button>
                    </div>
                @endif
            </div>
...
<!-- ======================= POP UP 1: PASSWORD MODAL (HIJAU) ======================= -->
<div id="passwordModal" class="fixed inset-0 bg-gray-900/60 backdrop-blur-xs flex items-center justify-center z-50 hidden p-4">
    <div class="bg-white rounded-2xl shadow-2xl overflow-hidden w-full max-w-md transform transition-all">
        <!-- Modal Header Hijau -->
        <div class="bg-gradient-to-r from-emerald-600 to-teal-500 p-4 text-white">
            <div class="flex justify-between items-center">
                ...
                <button onclick="hidePasswordModal()" class="text-white/80 hover:text-white focus:outline-none transition">
            ...
            <form id="password-form" method="POST" action="{{ route('dashboard.update') }}">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="password" name="current_password" id="current_password" required
                               class="w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:border-emerald-500 transition">
                    ...
                    <div>
                        ...
                        @error('new_password')
                            <p class="mt-1 text-xs text-red-600 flex items-center">
                                ...
                                {{ $message == 'The new password must be at least 8 characters.' ? 'Password baru minimal 8 karakter' : $message }}
                            </p>
                        @enderror
                    </div>
                    ...
                    <div>
                        <label for="new_password_confirmation" class="block text-sm font-semibold text-gray-700 mb-1">
                ...
                <div class="mt-6 flex justify-end space-x-3 pt-3 border-t border-gray-100">
                    <button type="button" onclick="hidePasswordModal()"
                            class="px-4 py-2 border border-gray-300 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-emerald-300 transition">
                        Batal
                    </button>
                    <button type="submit"
                            class="px-5 py-2 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-xl shadow-md text-sm font-semibold text-white hover:from-emerald-600 hover:to-teal-700 focus:outline-none focus:ring-2 focus:ring-emerald-400 transition transform hover:-translate-y-0.5">
                        Simpan Perubahan
                    </button>
                </div>
            </form>
...
<!-- ======================= POP UP 2: MODAL MASA KERJA (HIJAU) ======================= -->
<div id="masaKerjaModal" class="fixed inset-0 bg-gray-900/60 backdrop-blur-xs hidden flex items-center justify-center z-50 p-4">
    <div class="w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden transform transition-all duration-300 ease-out">
        <!-- Modal Header Hijau -->
        <div class="bg-gradient-to-r from-emerald-600 to-teal-500 p-4 text-white">
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-3">
                    ...
                    <h3 class="text-xl font-bold tracking-tight">Hitung Masa Kerja</h3>
                </div>
                <button onclick="closeModal()" class="p-1 rounded-full hover:bg-white/20 transition-colors focus:outline-none">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                    </svg>
                </button>
        ...
        <div class="p-6 space-y-6">
            <!-- Honorer Section (Hijau) -->
            <div class="bg-emerald-50/70 rounded-xl p-3.5 border border-emerald-100">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label for="honoryear" class="block text-xs font-medium text-emerald-700 mb-1.5">Tahun</label>
                        <input type="number" id="honoryear" min="0" value="0" 
                               class="w-full px-3 py-2 text-sm bg-white border border-emerald-200 rounded-xl focus:ring-2 focus:ring-emerald-300 focus:border-emerald-400 transition-all">
                    </div>
                    <div>
                        <label for="honormonth" class="block text-xs font-medium text-emerald-700 mb-1.5">Bulan</label>
                        <select id="honormonth" class="w-full px-3 py-2 text-sm bg-white border border-emerald-200 rounded-xl focus:ring-2 focus:ring-emerald-300 focus:border-emerald-400 transition-all">
                            @for ($i = 0; $i < 12; $i++)
            ...
            <div class="space-y-3">
                <div>
                    <label for="selectedDate" class="block text-sm font-semibold text-gray-700 mb-1.5">Mulai Bekerja</label>
                    <div class="relative">
                        <input type="month" id="selectedDate" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-emerald-300 focus:border-emerald-400 transition-all">
                    </div>
                    <p id="dateError" class="text-red-600 text-xs mt-2 hidden">
                        <span class="inline-flex items-center px-2 py-1 bg-red-50 rounded-lg border border-red-100">
                ...
                <div>
                    <label for="currentDate" class="block text-sm font-semibold text-gray-700 mb-1.5">Tanggal Sekarang</label>
                    <input type="month" id="currentDate" value="{{ date('Y-m') }}" readonly
                           class="w-full px-3 py-2 text-sm bg-gray-100 border border-gray-300 rounded-xl text-gray-600">
                </div>
            </div>

            <!-- Result Box (Hijau) -->
            <div id="resultContainer" class="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl p-4 border border-emerald-100 hidden">
                <div class="flex items-center">
                    <span class="text-sm font-semibold text-emerald-900">Total Masa Kerja:</span>
                    <span id="result" class="text-base font-bold text-emerald-700 ml-3"></span>
                </div>
                <div class="mt-1 text-xs text-emerald-600 flex items-center">
                    <svg class="w-3.5 h-3.5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
        ...
        <div class="bg-gray-50 px-6 py-4 flex justify-end space-x-3 border-t border-gray-100">
            <button type="button" onclick="closeModal()" 
                    class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-xl hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-emerald-300 transition-all">
                Batal
            </button>
            <button type="button" onclick="hitungSelisih()" 
                    class="px-5 py-2 text-sm font-semibold text-white bg-gradient-to-r from-emerald-600 to-teal-600 rounded-xl hover:from-emerald-700 hover:to-teal-700 focus:outline-none focus:ring-2 focus:ring-emerald-300 shadow-md shadow-emerald-200 transition-all">
                Hitung
            </button>
        ...
        <!-- Form Handling -->
        @if($masakerja)
            <form action="{{ route('usermasakerja.update', $masakerja->id) }}" method="POST" id="masaKerjaForm">
                @csrf
                @method('PUT')
        ...
        @else
            <form action="{{ route('usermasakerja.store') }}" method="POST" id="masaKerjaForm">
                @csrf
                <input type="hidden" name="user_id" value="{{ auth()->user()->id }}">
                <input type="hidden" name="jumlah_masa_kerja" id="masaKerjaInput">
            </form>
...
@if(session('success'))
<div id="successAlert" class="fixed bottom-4 right-4 flex items-center p-4 mb-4 text-sm text-green-800 bg-green-100 rounded-xl shadow-lg animate-bounce z-50">
...
@if($errors->any())
<div id="errorAlert" class="fixed bottom-4 right-4 flex items-center p-4 mb-4 text-sm text-red-700 bg-red-100 rounded-xl shadow-lg animate-bounce z-50">
    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
    </svg>
    Gagal menyimpan perubahan. Silakan periksa formulir kembali.
</div>
@endif
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const honorEl = document.getElementById('honoryear');
        if (honorEl) honorEl.addEventListener('input', validateHonor);

        const dateEl = document.getElementById('selectedDate');
        if (dateEl) dateEl.addEventListener('change', validateDate);

        const formEl = document.getElementById('masaKerjaForm');
    ...
    function hitungSelisih() {
        if (!validateHonor() || !validateDate()) return;
        ...
        if (!selectedDate || !currentDate) {
            alert('Harap tentukan tanggal mulai bekerja!');
            return;
        }
        ...
        let totalMonths = ((parseInt(currentParts[0]) - parseInt(selectedParts[0])) * 12 + (parseInt(currentParts[1]) - parseInt(selectedParts[1]))) + (honoryear * 12 + honormonth);
    ...
    window.onclick = function(event) {
        ...
        const mModal = document.getElementById('masaKerjaModal');
        if (event.target === pModal) hidePasswordModal();
        if (event.target === mModal) closeModal();
    }
