...
<head>
    ...
    <title>Sibaco | Widyaiswara</title>
        ...
        <aside class="sidebar w-64 bg-white border-r border-gray-100 flex flex-col select-none z-50">
            ...
            <div class="px-6 pt-6 pb-2 flex flex-col items-center text-center">
                ...
                <div class="mt-3 flex flex-col items-center w-full">
                    <span class="text-xs font-semibold text-gray-700">Widyaiswara</span>
                ...
                <div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <a href="{{ route('widyaiswarapengajuancutitahunan.index') }}"
                            class="flex items-center space-x-3 px-3 py-2.5 rounded-2xl {{ request()->routeIs('widyaiswarapengajuancutitahunan*') ? 'bg-gradient-to-r from-[#00c58e] to-[#6fc43a] text-white font-semibold shadow-md shadow-emerald-500/20' : 'text-gray-600 hover:bg-gray-50' }} transition-all">
                            <div class="w-7 h-7 rounded-lg {{ request()->routeIs('widyaiswarapengajuancutitahunan*') ? 'bg-white/20 text-white' : 'bg-[#e6fcf5] text-[#00c58e]' }} flex items-center justify-center flex-shrink-0">
                        ...
                        <a href="{{ route('widyaiswarapengajuancutiumum.index') }}"
                            class="flex items-center space-x-3 px-3 py-2.5 rounded-2xl {{ request()->routeIs('widyaiswarapengajuancutiumum*') ? 'bg-gradient-to-r from-[#00c58e] to-[#6fc43a] text-white font-semibold shadow-md shadow-emerald-500/20' : 'text-gray-600 hover:bg-gray-50' }} transition-all">
                            <div class="w-7 h-7 rounded-lg {{ request()->routeIs('widyaiswarapengajuancutiumum*') ? 'bg-white/20 text-white' : 'bg-[#e6fcf5] text-[#00c58e]' }} flex items-center justify-center flex-shrink-0">
            ...
            <div class="p-4 border-t border-gray-100 mt-auto">
                <div class="flex items-center space-x-3 mb-4 px-1">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-xs font-semibold text-gray-800 truncate" title="{{ Auth::user()->name ?? 'Pengguna' }}">
                            {{ Auth::user()->name ?? 'Pengguna' }}
                        </p>
                        <p class="text-[10px] text-gray-400 truncate mt-0.5">
                            {{ Auth::user()->jabatan ?? 'Widyaiswara' }}
                        </p>
                    </div>
                </div>
