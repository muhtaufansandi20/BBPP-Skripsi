...
@section('content')
    <div class="max-w-3xl mx-auto bg-white px-6 py-8 pt-6 rounded-xl shadow-lg border border-gray-100">
        <!-- Header Section -->
        <div
            class="mb-8 bg-white rounded-xl border border-gray-100 shadow-[0_2px_10px_rgba(0,0,0,0.05)] overflow-hidden backdrop-blur-sm bg-opacity-80">
            <div class="px-4 py-3 bg-gradient-to-r from-green-500 to-lime-500 border-b border-gray-100">
                <div class="flex items-center justify-between">
                    ...
                    <span
                        class="text-xs font-medium bg-white text-emerald-500 px-2.5 py-1 rounded-full border border-orange-100 shadow-sm">
                        {{ now()->year }}
                    </span>
                </div>
            </div>
        ...
        <div class="mb-8 group">
            <h2 class="text-lg sm:text-xl font-semibold mb-1 relative inline-block">
                ...
                <span
                    class="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-green-300 to-yellow-300 rounded-full opacity-75 group-hover:opacity-100 transition-opacity duration-300"></span>
            </h2>
            <p class="text-xs text-gray-500 flex items-center gap-2">
                <span
                    class="inline-flex w-3 h-3 bg-gradient-to-r from-green-400 to-lime-400 rounded-full animate-pulse"></span>
        ...
        <!-- Form Section -->
        <form action="{{ route('katimkerpengajuancutitahunan.store') }}" method="POST" class="space-y-6" id="leaveForm">
            @csrf
            ...
            <div>
                ...
                <p id="dateError" class="mt-2 text-sm text-red-600 hidden">Tanggal selesai harus lebih besar atau sama
                    dengan tanggal mulai</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="no_hp_cuti" id="no_hp_cuti"
                        class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary/50 focus:border-primary"
                        required>
                    <p id="phoneError" class="mt-2 text-sm text-red-600 hidden">Nomor HP tidak valid. Gunakan format yang
                        benar (contoh: 081234567890)</p>
                </div>
            </div>
