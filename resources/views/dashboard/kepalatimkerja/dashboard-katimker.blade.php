...
<div class="bg-white rounded-xl shadow-sm overflow-hidden">
    {{-- <div class="bg-gradient-to-l from-yellow-300 via:yellow-400 to-yellow-500 p-6"> --}}
    <div class="bg-gradient-to-l from-yellow-400 to-amber-500 p-6">
                ...
                <div class="bg-white rounded-lg border border-gray-100 p-6 w-full md:w-3/5">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4 flex items-center group relative">
                        ...
                        <div class="relative mr-3">
                            <!-- Main Icon -->
                            <svg class="w-6 h-6 text-gray-500 group-hover:text-yellow-600 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="absolute -inset-1.5 rounded-full bg-yellow-100 opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10"></div>
                        </div>
                        <span class="relative">
                            Informasi Pribadi
                            <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-yellow-500 to-yellow-400 group-hover:w-full transition-all duration-500 ease-out"></span>
                        </span>
                        <span class="ml-2 px-1.5 py-0.5 text-xs font-medium rounded-full bg-yellow-100 text-yellow-800 opacity-0 group-hover:opacity-100 translate-x-1 group-hover:translate-x-0 transition-all duration-300">
                            Anda
                        </span>
                    </h2>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        {{-- <div>
                            <div class="flex items-center">
                                ...
                                <button onclick="toggleEdit('email')" class="ml-2 text-gray-400 hover:text-accent focus:outline-none">
                                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                    </svg>
                                </button>
                            </div>
                            <p class="mt-1 text-gray-700">{{ $user->e_mail }}</p>
                            <form id="email-form" class="hidden mt-2" method="POST" action="{{ route('dashboard.update') }}">
                                @csrf
                                <div class="flex">
                                    <input type="email" name="e_mail" value="{{ old('e_mail', $user->e_mail) }}" class="flex-1 px-2 py-1 rounded-l text-gray-800 text-sm">
                        ...
                        <div>
                            <div class="flex items-center">
                                ...
                                <button onclick="toggleEdit('phone')" class="ml-2 text-gray-400 hover:text-yellow-500 focus:outline-none">
                                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                    </svg>
                                </button>
                        ...
                        <div>
                            <div class="flex items-center">
                                ...
                                <button onclick="showPasswordModal()" class="ml-2 text-gray-400 hover:text-yellow-500 focus:outline-none">
                                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                    </svg>
                                </button>
                    ...
                    <div class="p-2">
                        <div class="flex items-center justify-between mb-4">
                            <h2 class="text-sm font-semibold text-gray-800 flex items-center group relative">
                                <svg class="w-5 h-5 mr-2 text-yellow-500 transition-all duration-500 group-hover:text-yellow-600 group-hover:rotate-12" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                                ...
                                <span class="relative">
                                    Masa Kerja
                                    <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-yellow-500 to-yellow-200 group-hover:w-full transition-all duration-300"></span>
                                </span>
                                <span class="ml-1.5 w-2 h-2 rounded-full bg-yellow-500 animate-pulse opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                            </h2>
            ...
            <div class="bg-white rounded-lg border border-gray-100 p-6 mt-6">
                <h2 class="text-lg font-semibold text-gray-800 mb-4 flex items-center group relative">
                    ...
                    <span class="hidden sm:flex ml-2 px-2 py-0.5 text-xs font-medium rounded-full bg-gradient-to-r from-purple-100 to-fuchsia-100 text-purple-800 opacity-0 group-hover:opacity-100 translate-y-1 group-hover:translate-y-0 transition-all duration-300 items-center">
                        <span class="w-1.5 h-1.5 rounded-full bg-purple-500 mr-1 animate-pulse text-center"></span>
                        Sisa Kuota
                    </span>
                </h2>
                ...
                @else
                    ...
                    <div class="bg-purple-50 rounded-xl p-6 text-center border-2 border-dashed border-purple-200">
                        ...
                        <button onclick="window.open('https://wa.me/{{ $whatsappNumber }}?text={{ $defaultMessage }}', '_blank')" 
                                class="mt-4 px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors flex items-center mx-auto {{ empty($whatsappNumber) ? 'opacity-50 cursor-not-allowed' : '' }}"
        ...
        <div class="p-6">
            <form id="password-form" method="POST" action="{{ route('dashboard.update') }}">
                ...
                <div class="mt-6 flex justify-end space-x-3">
                    ...
                    <button type="submit"
                            class="px-4 py-2 bg-gradient-to-r from-green-500 to-emerald-500 rounded-lg shadow-sm text-sm font-medium text-white hover:from-green-600 hover:to-emerald-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-400 transition transform hover:-translate-y-0.5">
                        Simpan Perubahan
                    </button>
                </div>
            </form>
...
<div id="masaKerjaModal" class="fixed inset-0 bg-gray-900/70 hidden flex items-center justify-center z-50 p-4">
    <div class="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden transform transition-all duration-300 ease-out">
        <!-- Modal Header -->
        <div class="bg-gradient-to-r from-primary to-primary/70 p-4 text-gray-100">
            <div class="flex justify-between items-center">
        ...
        <div class="bg-gray-50 px-6 py-4 flex justify-end space-x-3 border-t border-gray-200">
            ...
            <button type="button" onclick="hitungSelisih()" 
                    class="px-5 py-2.5 text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-cyan-600 rounded-xl hover:from-blue-700 hover:to-cyan-700 focus:outline-none focus:ring-2 focus:ring-blue-300 shadow-md hover:shadow-blue-200 transition-all">
                Hitung
            </button>
            <button type="submit" id="saveButton" form="masaKerjaForm" hidden
                    class="px-5 py-2.5 text-sm font-medium text-white bg-gradient-to-r from-green-600 to-emerald-600 rounded-xl hover:from-green-700 hover:to-emerald-700 focus:outline-none focus:ring-2 focus:ring-green-300 shadow-md hover:shadow-green-200 transition-all">
        ...
        @if($masakerja)
            <form action="{{ route('katimkermasakerja.update', $masakerja->id) }}" method="POST" id="masaKerjaForm">
                @csrf
                @method('PUT')
        ...
        @else
            <form action="{{ route('katimkermasakerja.store') }}" method="POST" id="masaKerjaForm">
                @csrf
                <input type="hidden" name="user_id" value="{{ auth()->user()->id }}">
                <input type="hidden" name="jumlah_masa_kerja" id="masaKerjaInput">
            </form>
