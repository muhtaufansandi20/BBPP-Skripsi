...
<div class="container mx-auto px-4 py-8">
    <div class="bg-white rounded-xl shadow-lg p-8">
        <!-- Header Section -->
        <div class="mb-8">
            <h1 class="text-2xl md:text-3xl font-bold text-gray-800 mb-2">Kelola Tanda Tangan Digital</h1>
            <p class="text-gray-600">Kelola tanda tangan digital untuk kepala bagian dan kepala balai</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
            ...
            <div class="bg-gradient-to-br from-gray-50 to-white p-6 rounded-xl border border-gray-100 shadow-sm">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <span class="px-3 py-1 text-xs font-medium rounded-full bg-blue-100 text-blue-800">Required</span>
                </div>
        ...
        <div class="mt-10 p-6 rounded-xl bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200">
            <div class="flex items-start">
                ...
                <div class="ml-4">
                    <h2 class="text-lg font-semibold text-blue-800 mb-3">Panduan Membuat Tanda Tangan Digital</h2>
...
<script>
// File name display for both forms
