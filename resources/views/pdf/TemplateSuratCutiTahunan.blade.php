...
<head>
    ...
    <title>Form Permintaan dan Pemberian Cuti</title>
    ...
    <style>
        ...
        @page {
            ...
            margin: 5mm 5mm 2mm 5mm; /* Kurangi margin bawah menjadi 3mm */
        }

        body {
            font-family: Arial, sans-serif;
            margin: 8px; /* Kurangi margin agar lebih banyak ruang */
            font-size: 12px; /* Ukuran font lebih kecil */
        }

        h1, h2 {
            text-align: center;
            font-size: 12px; /* Ukuran heading lebih kecil */
        }

        table {
            width: 100%;
            border-collapse: collapse;
            margin: 7px 0; /* Kurangi margin tabel */
            font-size: 12px; /* Ukuran font lebih kecil dalam tabel */
        }

        th, td {
            border: 1px solid #000;
            padding: 3px; /* Kurangi padding agar tabel lebih rapat */
            text-align: left;
        }

        th {
            background-color: #f2f2f2;
            font-size: 10px; /* Kecilkan font heading tabel */
        }
        footer {
...
<body> 
    ...
    <!-- Tambahan tanggal dan tujuan surat -->
    ...
    <table>
        ...
        <tr>
            ...
            <td style="font-family: DejaVu Sans, sans-serif; text-align: center;"><strong>&#10004;</strong></td>
            <td>2. Cuti Besar</td>
            <td></td>
        </tr>
        <tr>
    ...
    <table>
        ...
        <tr>
            <td>Selama</td>
            <td style="text-align: center;">{{ $cuti->lama_cuti }} Hari</td>
    ...
    <table border="1">
        ...
        <tr>
            ...
            <td colspan="2"><strong>3. CUTI SAKIT</strong></td>
            <td></td>
        </tr>
        <tr>
            <td>N-2</td>
            ...
            <td>Hari</td>
            <td colspan="2"><strong>4. CUTI MELAHIRKAN</strong></td>
            <td></td>
        </tr>
        <tr>
            <td>N-1</td>
            ...
            <td>Hari</td>
            <td colspan="2"><strong>5. CUTI KARENA ALASAN PENTING</strong></td>
            <td></td>
        </tr>
        <tr>
            <td>N</td>
            ...
            <td>Hari</td>
            <td colspan="2"><strong>6. CUTI DI LUAR TANGGUNGAN NEGARA</strong></td>
            <td></td>
        </tr>
    </table>
    ...
    <table border="1" width="100%" cellspacing="0" cellpadding="4">
        <tr>
            <th colspan="2" align="left">VI. ALAMAT SELAMA MENJALANKAN CUTI</th>
        </tr>
        <tr>
            <td width="70%" rowspan="2" style="padding-left:15px; font-size: 12px;">
                {{ $cuti->alamat_saat_cuti ?? '-' }}<br>
            </td>            
            <td width="30%"><b>Telp.</b> &nbsp; {{ $cuti->no_hp_cuti ?? '-' }}</td>
        </tr>
        <tr>
            <td align="center" style="vertical-align: middle; height: 10px; text-align: center;">
                Hormat Saya,<br><br><br><br> <!-- Jarak untuk tanda tangan -->
                ...
                <td rowspan="2" style="text-align: center; vertical-align: middle; height: 90px; position: relative;">
                    ...
                    <div style="position: absolute; top: 10px; left: 50%; transform: translateX(-50%); z-index: 10;">
                        @if(isset($ttdKabagPath) && $ttdKabagPath)
                            <img src="{{ public_path('storage/'.$ttdKabagPath) }}" alt="Tanda Tangan Kabag" width="150" height="60">
                        @endif
                    </div>
    ...
    <table>
        <tr>
            <th colspan="4">
                {{ $cuti->is_kabag ? 'VII' : 'VIII' }}. KEPUTUSAN PEJABAT YANG BERWENANG MEMBERIKAN CUTI**
            </th>
        </tr>        
        <tr>
            <th width="23%">DISETUJUI</th>
