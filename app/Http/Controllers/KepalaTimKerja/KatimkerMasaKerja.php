...
class KatimkerMasaKerja extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('dashboard.kepalatimkerja.masakerja-katimker', compact('masakerja'));
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('katimkermasakerja.index')
