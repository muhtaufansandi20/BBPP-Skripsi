...
class KabagPengajuanCutiTahunan extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        // Query pengajuan cuti khusus untuk kepala bagian (is_kabag = true)
        ...
        return view('dashboard.kepalabagian.datapengajuancutitahunan-kabag', compact('pengajuancutitahunan', 'checkVerifikasi', 'hasWorkPeriod', 'admin', 'user'));
    }
    ...
    public function create()
    {
        ...
        return view('dashboard.kepalabagian.createpengajuancutitahunan-kabag', compact('user', 'checkUser', 'masakerja', 'kuotaCuti'));
    }
    ...
    public function store(Request $request) 
    {
        ...
        $pengajuanCuti = PengajuanCutiTahunan::create([
            ...
            'is_kabag' => true, // Menandai bahwa ini pengajuan dari kepala bagian
        ]);
        ...
        return redirect()->route('kabagpengajuancutitahunan.index')->with('success', 'Pengajuan Cuti berhasil diajukan.');
    }
    ...
    public function show($id)
    {
        ...
        // Mengambil status & catatan pengajuan cuti di berbagai level persetujuan (untuk Kabag)
        ...
        return view('dashboard.kepalabagian.detailpengajuancutitahunan-kabag', compact(
 ...
 */
    public function destroy(string $id)
    {
        try {
            ...
            if (!$pengajuanCuti) {
                return redirect()->route('kabagpengajuancutitahunan.index')
